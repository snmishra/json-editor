...
Scenario('should validate against oneOf schemas and display single oneOf and editors error messages @core @oneof', async ({ I }) => {
  ...
  I.waitForText('Value must validate against exactly one of the provided schemas. It currently validates against 0 of the schemas.')
  I.waitForText(`Object is missing the required property 'p1'`)
  I.waitForText(`Object is missing the required property 'p2'`)
  ...
  I.click('Get Value')
  I.wait(1)
  I.dontSeeElement('[data-schemapath="root.p4"] .invalid-feedback')
  I.dontSeeElement('[data-schemapath="root.p5.p1"] .invalid-feedback')
  I.dontSeeElement('[data-schemapath="root.p5.p2"] .invalid-feedback')
})
